...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_fg0, col_orange,  col_orange  },
};
...
static const char *dmenucmd[] = { "dmenu_run","-c", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_orange, "-sf", col_gray4, NULL };
